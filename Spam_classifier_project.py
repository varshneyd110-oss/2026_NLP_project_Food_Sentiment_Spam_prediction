...
def send_otp_email(receiver_email, otp):
        ...
        sender_email = "varshneyd110@gmail.com"
        app_password = "xtjm kmlt bkpg nxtw"
        ...
        server = smtplib.SMTP("smtp.gmail.com", 587)  #SSL use tab yhai code 465
        server.starttls()
...
def run_spam_app():
    ...
    def login_spam_page():
        USE_REAL_EMAIL = False   # 👈 abhi demo, baad me True kar dena
    ...
    .title:hover {{
        ...
        with col1:
            show_btn = st.button("📂 Show History")
