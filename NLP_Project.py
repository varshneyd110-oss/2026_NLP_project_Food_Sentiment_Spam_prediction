...
from news_classification_project import run_news_app
...
def main_news_sidebar():
        ...
        "<b style='color:orange;'>Politics</b>, <b style='color:green;'>Sports</b>, "
        "<b style='color:#FF69B4;'>Entertainment</b>, <b style='color:#FFD700;'>Economics</b> 📰</p>"
        ...
        st.sidebar.markdown(
        """
        ✔ 🏛️ <span style='color:#FFD93D;'>Politics</span><br>
        ✔ ⚽ <span style='color:#4D96FF;'>Sports</span><br>
        ✔ 🎬 <span style='color:#FF6B6B;'>Entertainment</span><br>
        ✔ 💰 <span style='color:#6BCB77;'>Economics</span><br>
        ✔ 🙏 <span style='color:#00FFFF;'>Religious</span>
        """,
        unsafe_allow_html=True
        )
        ...
        st.sidebar.markdown(
        """
        ✔ <span style='color:#FFD93D;'>TextBlob</span><br>
        ✔ <span style='color:#4D96FF;'>NLTK</span><br>
        ...
        st.sidebar.markdown(
        """
        🤖 <span style='color:#FFD700;'>Model:</span> Naive Bayes Classifier<br>
        ...
        "<p style='color:#00FFFF;'>Built using Machine Learning & NLP 🚀</p>",
        unsafe_allow_html=True
        )
...
def login_news_sidebar():
        ...
        "<b style='color:orange;'>Politics</b>, <b style='color:green;'>Sports</b>, "
        "<b style='color:#FF69B4;'>Entertainment</b>, <b style='color:#FFD700;'>Economics</b> using Machine Learning & NLP.</p>",
        unsafe_allow_html=True
        )
        st.sidebar.markdown("---")
        ...
        """
        🤖 <span style='color:#FFD700;'>Model:</span> Naive Bayes Classifier<br>
        🧠 <span style='color:#00FFAA;'>NLP Techniques Used</span><br>
        ⚡ <span style='color:#4D96FF;'>Fast Prediction</span><br>
        🔍 <span style='color:#FF6B6B;'>Text Cleaning + Stopwords Removal</span>
        """,
        unsafe_allow_html=True
        )
        st.sidebar.markdown("---")
...
# Tabs
tab1, tab2 , tab3 = st.tabs(["📩 Spam Classifier", "😊 Sentiment Analysis","📰 News Classifier "])
...
def predict_news(text):
    ...
    return news_model.classify(text)
...
# ---------------- TAB 3 ----------------
with tab3:
    st.markdown("## 📰 News Classification AI")

    news = st.text_area("Enter News Headline", key="news_text")

    if st.button("Classify News", key="news_btn", use_container_width=True):

        if news.strip() == "":
            st.warning("Please enter news headline")
        else:
            pred = predict_news(news)

            # 🎨 Category Style Mapping
            category_styles = {
                "SPORTS": {"color": "linear-gradient(90deg, #11998e, #38ef7d)", "emoji": "⚽"},
                "POLITICS": {"color": "linear-gradient(90deg, #1e3c72, #2a5298)", "emoji": "🏛️"},
                "ENTERTAINMENT": {"color": "linear-gradient(90deg, #ff416c, #ff4b2b)", "emoji": "🎬"},
                "ECONOMICS": {"color": "linear-gradient(90deg, #f7971e, #ffd200)", "emoji": "💰"},
                "RELIGIOUS": {"color": "linear-gradient(90deg, #8e2de2, #4a00e0)", "emoji": "🙏"}
            }
...
if st.session_state.page == "home":
    ...
    # Block UI
    if blocked:
        st.error("🚫 You are already logged into Sentiment or News")
    ...
    # ❗ Block UI
    if blocked:
        st.error("🚫 You are already logged into Spam or News")
        st.info("👉 Please logout first to continue")
    ...
    # ❗ Block UI
    if blocked:
        st.error("🚫 You are already logged into Spam or Sentiment")
        st.info("👉 Please logout first to continue")
