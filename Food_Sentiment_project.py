...
def run_sentiment_app():
    ...
    def login_sentiment_page():
        ...
        img_base64 = get_base64_image("background_3.png")
        ...
        <div class="banner">
            <div class="banner-content">
                ...
                <div class="rotator-inner">
                            ...
                            <!-- ORIGINAL -->
                            <div class="slide">
                                <div class="title">🍽️ Food Sentiment AI 😊</div>
                                <div class="subtitle">Analyze restaurant feedback & discover what customers truly feel ❤️😋</div>
                                <div id="clock"></div>
                            </div>

                            <div class="slide">
                                <div class="title">🍽️ Food Sentiment AI 😊</div>
                                <div class="subtitle">Turning food reviews into powerful insights with smart NLP 🚀</div>
                                <div id="clock2"></div>
                            </div>
    ...
    .title:hover {{
        ...
        with col2:
            st.markdown(
                create_download_link(csv, "email.csv", "⬇️ Email Dataset", "email"),
                unsafe_allow_html=True
            )
